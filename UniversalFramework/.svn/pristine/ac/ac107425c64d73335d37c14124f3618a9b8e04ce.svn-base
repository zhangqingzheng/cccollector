...
public abstract class GenericEditBean<T> extends BaseBean {
	 ...
	 * 图片文件路径映射
	 */
	protected Map<Integer, String> pictureFilePathMap = new HashMap<>();
	 ...
	 * 图片图像映射
	 */
	protected Map<Integer, StreamedContent> pictureImageMap = new HashMap<>();
	 ...
	 * 图片信息映射
	 */
	protected Map<Integer, SimpleImageInfo> pictureInfoMap = new HashMap<>();
	...
	public void handlePictureFileUpload(FileUploadEvent fileUploadEvent) {
		...
		int index = Integer.parseInt(clientId.substring(clientId.lastIndexOf("_") + 1));
		try {
	 ...
	 * 文件格式映射
	 */
	protected Map<Integer, String> fileFormatMap = new HashMap<>();

	/**
	 * 文件路径映射
	 */
	protected Map<Integer, String> filePathMap = new HashMap<>();
	 ...
	 * 文件映射
	 */
	protected Map<Integer, StreamedContent> fileMap = new HashMap<>();
