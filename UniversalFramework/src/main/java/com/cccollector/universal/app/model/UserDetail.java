...
public class UserDetail implements UserDetails {
	...
	public List<AppManagementGrantedAuthority> getAuthorities() {
		if (_authorities == null) {
			...
			AppManagementGrantedAuthority appManagementGrantedAuthority = new AppManagementGrantedAuthority();
			appManagementGrantedAuthority.setAuthority("ROLE_USER");
			_authorities.add(appManagementGrantedAuthority);
		}
		return _authorities;
	}
	...
	private Map<String, Module> _modulePermissions;

	/**
	 * 模块权限
	 */
	public Map<String, Module> getModulePermissions() {
		return _modulePermissions;
	}

	public void setModulePermissions(Map<String, Module> modulePermissions) {
		_modulePermissions = modulePermissions;
	}
}
