...
public class Issue implements Serializable {
	 ...
	 * 封面URL路径
	 */
	public String coverUrlPath(long index) {
		return getIssueUrlPath() + _issueId + "_cover_" + (index + 1) + ".jpg";
	}

	/**
	 * 封面文件路径
	 */
	public String coverFilePath(long index) {
		return getIssueFilePath() + _issueId + "_cover_" + (index + 1) + ".jpg";
	}
	 ...
	 * 预览URL路径
	 */
	public String previewUrlPath(long index) {
		return getIssueUrlPath() + _issueId + "_preview_" + (index + 1) + ".jpg";
	}
	
	/**
	 * 预览文件路径
	 */
	public String previewFilePath(long index) {
		return getIssueFilePath() + _issueId + "_preview_" + (index + 1) + ".jpg";
	}
