...
import com.cccollector.news.service.FollowService;
...
public abstract class BaseListBean<T> extends GenericListBean<T> {
	 ...
	 * 关注服务
	 */
	@ManagedProperty(value = "#{followService}")
	protected FollowService followService;

	public void setFollowService(FollowService _followService) {
	 ...
	 * 收藏服务
	 */
	@ManagedProperty(value = "#{favoriteService}")
	protected FavoriteService favoriteService;

	public void setFavoriteService(FavoriteService _favoriteService) {
	...
	public void setCommentService(CommentService _commentService) {
	 ...
	 * 评论审核服务
	 */
	@ManagedProperty(value = "#{commentReviewService}")
	protected CommentReviewService commentReviewService;

	public void setCommentReviewService(CommentReviewService _commentReviewService) {
		commentReviewService = _commentReviewService;
	}

	/**
	 * 回复服务
	 */
	@ManagedProperty(value = "#{replyService}")
	protected ReplyService replyService;

	public void setReplyService(ReplyService _replyService) {
	 ...
	 * 喜欢服务
	 */
	@ManagedProperty(value = "#{likeService}")
	protected LikeService likeService;

	public void setLikeService(LikeService _likeService) {
	 ...
	 * 不喜欢服务
	 */
	@ManagedProperty(value = "#{dislikeService}")
	protected DislikeService dislikeService;

	public void setDislikeService(DislikeService _dislikeService) {
	...
	public void setReportService(ReportService _reportService) {
	...
	public void setLogService(LogService _logService) {
