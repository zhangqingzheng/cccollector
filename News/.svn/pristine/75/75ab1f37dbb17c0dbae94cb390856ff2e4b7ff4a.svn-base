 ...
 */
@Entity
@Table(name = "app_columnSubstitutes")
public class ColumnSubstitute implements Serializable {
	
	private static final long serialVersionUID = -3834839975991607900L;
	
	private Integer _columnSubstituteId;
	...
	public Integer getColumnSubstituteId() {
		return _columnSubstituteId;
	}

	public void setColumnSubstituteId(Integer columnSubstituteId) {
		_columnSubstituteId = columnSubstituteId;
	}
